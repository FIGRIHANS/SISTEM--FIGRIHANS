...
<template>
  ...
  <div class="w-full">
    <h2 class="text-5xl font-bold tracking-tighter leading-none text-gray-800 text-left md:text-4xl">
      Lorem ipsum dolor sit amet
    </h2>
    <p class="mt-8 text-base leading-7 text-neutral-600 text-left">
  ...
  <div class="w-full mt-12">
    <h3 class="text-4xl font-bold tracking-tighter leading-tight text-gray-800 text-left">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.
    </h3>
    <p class="mt-6 text-base leading-7 text-neutral-600 text-left">
